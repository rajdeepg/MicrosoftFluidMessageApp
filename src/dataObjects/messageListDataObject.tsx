...
export class MessageList extends DataObject {
    ...
    protected async hasInitialized() {
        this.messages = await this.root.get<IFluidHandle>("messageSequence").get() as SharedObjectSequence<IMessage>;

        this.messages.on("op", () => {
            this.emit("messageSequence")
        })

        this.messageTitle = await this.root.get<IFluidHandle>("messageString").get() as SharedString;
